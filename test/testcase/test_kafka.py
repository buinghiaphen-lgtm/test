...
def realtime_kafka_fixture(request):
    ...
    if data[0] != '分页推送' and data[0] != '循环推送':
        # 获取当前时间 和 当前时间的小时
...
class TestKafka:
    ...
    def test_greaterinterval_diffdayrestart(self, realtime_kafka_fixture):
        # 测试用例4：推送服务中断大于X小时且跨天重启    注意
        logger.info('-------------------- 开始测试...推送服务中断大于X小时且跨天重启 --------------------')
        asyncio.run(self.bd_data(4))
    ...
    def test_paging(self, realtime_kafka_fixture):
        # 测试用例7：分页推送---
        asyncio.run(self.bd_data(7))
    ...
    async def bd_ticket(self, flag, countflag):
        ...
        logger.info(f'bd_ticket自己select出来的条数---{count}')
        # 传参数据条数，去kafka里取数据
        ...
        logger.info(f'bd_ticket在kafka拿到的的条数{data_list_len}')
        # 先比较条数是否正确
    ...
    async def bd_cancel_ticket(self, flag, countflag):
        ...
        logger.info(f'bd_cancel_ticket自己select出来的条数{count}')
        # 传参数据条数，去kafka里取数据
        ...
        logger.info(f'bd_cancel_ticket在kafka拿到的的条数{data_list_len}')
        # 先比较条数是否正确
    ...
    async def bd_undo_ticket(self, flag, countflag):
        ...
        logger.info(f'bd_undo_ticket自己select出来的条数{count}')
        # 传参数据条数，去kafka里取数据
        ...
        logger.info(f'bd_undo_ticket在kafka拿到的的条数{data_list_len}')
        # 先比较条数是否正确
    ...
    async def bd_win_ticket(self, flag, countflag):
        ...
        logger.info(f'bd_win_ticket自己select出来的条数{count}')
        # 传参数据条数，去kafka里取数据
        ...
        logger.info(f'bd_win_ticket在kafka拿到的的条数{data_list_len}')
        # 先比较条数是否正确
    ...
    async def bd_paid_ticket(self, flag, countflag):
        ...
        logger.info(f'bd_paid_ticket自己select出来的条数{count}')
        # 传参数据条数，去kafka里取数据
        ...
        logger.info(f'bd_paid_ticket在kafka拿到的的条数{data_list_len}')
        # 先比较条数是否正确
    ...
    async def bd_win_ticket_prize(self, flag, countflag):
        ...
        logger.info(f'bd_win_ticket_prize自己select出来的条数{count}')
        # 传参数据条数，去kafka里取数据
        ...
        logger.info(f'bd_win_ticket_prize在kafka拿到的的条数{data_list_len}')
        # 先比较条数是否正确
